...
latex_documents = [
  ('index', 'OdooRPC.tex', u'OdooRPC Documentation',
   u'Sébastien Alix', 'manual'),
]
...
man_pages = [
    ('index', 'odoorpc', u'OdooRPC Documentation',
     [u'Sébastien Alix'], 1)
]
...
texinfo_documents = [
  ('index', 'OdooRPC', u'OdooRPC Documentation',
   u'Sébastien Alix', 'OdooRPC', 'One line description of project.',
   'Miscellaneous'),
]
