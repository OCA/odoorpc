...
project = "OdooRPC"
copyright = "2014-{0}, Sébastien Alix".format(datetime.now().year)
...
latex_documents = [
    ("index", "OdooRPC.tex", "OdooRPC Documentation", "Sébastien Alix", "manual"),
]
...
man_pages = [("index", "odoorpc", "OdooRPC Documentation", ["Sébastien Alix"], 1)]
